...
export type WorkerSendTypes = "load" | "fromCsv" | "reset" | "getVisibleCount" | "getVisibleRows" | "valueListInfo" | "valueCellList" | "mark" | "filterByValue" | "filterEntireColumn" | "filterRowsByResponseTime" | "getStatistics" | "getValueCount";
